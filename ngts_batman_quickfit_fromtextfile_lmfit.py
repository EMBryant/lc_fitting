...
def lc_bin(time, flux, bin_width):
	...
	return time_bin, flux_bin, err_bin, dig	
...
def lc_fit(fn, period, epoc, objid, fit_t0=False):
    ...
    if fit_t0: 
        ...
        print('Best fit parameters: rp={:.4f}; a={:.4f}; inc={:.4f}; t0={:.4f}'.format(rp_best, a_best, inc_best, t0_best))
    else:	
    ...
    p_bin, f_bin, e_bin, dig = lc_bin(p_fit, f_fit, bw)
...
#    plt.savefig('/home/astro/phrvdf/NGTS_fitting/quickfit_plots/NOI_{}_lcfit.png'.format(objid))
    ...
    plt.show()
    if fit_t0:
        return p_best, f_best, p_fit, f_fit, e_fit, rp_best, a_best, inc_best, t0_best, t_dur, t_depth, res, dig
    else:	
        return p_best, f_best, p_fit, f_fit, e_fit, rp_best, a_best, inc_best, t_dur, t_depth, res, dig
...
if __name__ == '__main__':
    ...
    if args.fit_t0:
        p_best, f_best, p_fit, f_fit, e_fit, rp_best, a_best, inc_best, t0_best, t_dur, t_depth, res, dig = lc_fit(args.fn, args.per, args.epoc, args.objid, fit_t0=True)
    else:
        p_best, f_best, p_fit, f_fit, e_fit, rp_best, a_best, inc_best, t_dur, t_depth, res, dig = lc_fit(args.fn, args.per, args.epoc, args.objid, fit_t0=False)
